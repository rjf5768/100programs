...
@.str.2 = private unnamed_addr constant [5 x i8] c"59.c\00", align 1
...
15:                                               ; preds = %24, %11
  ...
  br i1 %18, label %19, label %27, !dbg !36

19:                                               ; preds = %15
  %20 = load i32, i32* %4, align 4, !dbg !37
  %21 = mul nsw i32 2, %20, !dbg !38
  %22 = load i32, i32* %3, align 4, !dbg !39
  %23 = add nsw i32 %22, %21, !dbg !39
  store i32 %23, i32* %3, align 4, !dbg !39
  br label %24, !dbg !40
...
27:                                               ; preds = %15
  ...
  %29 = icmp slt i32 %28, 0, !dbg !48
  br i1 %29, label %30, label %31, !dbg !49

30:                                               ; preds = %27
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 noundef 12, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #4, !dbg !50
  unreachable, !dbg !50
...
!1 = !DIFile(filename: "59.c", directory: "/home/rongfeng/klee/code/100 programs", checksumkind: CSK_MD5, checksum: "e73c16fef88b9ea21ccea52da2831705")
...
!41 = !DILocation(line: 9, column: 27, scope: !33)
!42 = !DILocation(line: 9, column: 3, scope: !33)
!43 = distinct !{!43, !36, !44, !45}
!44 = !DILocation(line: 10, column: 16, scope: !29)
!45 = !{!"llvm.loop.mustprogress"}
!46 = !DILocation(line: 11, column: 6, scope: !47)
!47 = distinct !DILexicalBlock(scope: !10, file: !1, line: 11, column: 6)
!48 = !DILocation(line: 11, column: 10, scope: !47)
!49 = !DILocation(line: 11, column: 6, scope: !10)
