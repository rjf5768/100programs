...
@.str.3 = private unnamed_addr constant [5 x i8] c"31.c\00", align 1
...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  %9 = xor i32 %7, %8, !dbg !27
  store i32 %9, i32* %4, align 4, !dbg !28
  %10 = load i32, i32* %2, align 4, !dbg !29
  %11 = load i32, i32* %3, align 4, !dbg !31
  %12 = icmp eq i32 %10, %11, !dbg !32
  br i1 %12, label %13, label %17, !dbg !33

13:                                               ; preds = %0
  %14 = load i32, i32* %4, align 4, !dbg !34
  %15 = icmp ne i32 %14, 0, !dbg !35
  br i1 %15, label %16, label %17, !dbg !36

16:                                               ; preds = %13
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 noundef 12, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #4, !dbg !37
  unreachable, !dbg !37
...
!1 = !DIFile(filename: "31.c", directory: "/home/rongfeng/klee/code/100 programs", checksumkind: CSK_MD5, checksum: "6ac7a8cef3f812ba5aef4bda8711ad4e")
...
!19 = !DILocalVariable(name: "xor_val", scope: !10, file: !1, line: 6, type: !13)
...
!30 = distinct !DILexicalBlock(scope: !10, file: !1, line: 11, column: 6)
!31 = !DILocation(line: 11, column: 11, scope: !30)
!32 = !DILocation(line: 11, column: 8, scope: !30)
!33 = !DILocation(line: 11, column: 13, scope: !30)
!34 = !DILocation(line: 11, column: 16, scope: !30)
!35 = !DILocation(line: 11, column: 24, scope: !30)
!36 = !DILocation(line: 11, column: 6, scope: !10)
!37 = !DILocation(line: 12, column: 5, scope: !30)
!38 = !DILocation(line: 13, column: 3, scope: !10)
