...
(assert (let ( (?B1 (concat  (select  y (_ bv3 32) ) (concat  (select  y (_ bv2 32) ) (concat  (select  y (_ bv1 32) ) (select  y (_ bv0 32) ) ) ) ) ) (?B2 (concat  (select  x (_ bv3 32) ) (concat  (select  x (_ bv2 32) ) (concat  (select  x (_ bv1 32) ) (select  x (_ bv0 32) ) ) ) ) ) ) (and  (and  (and  (and  (bvsle  (_ bv4294967291 32) ?B2 ) (bvsle  ?B2 (_ bv5 32) ) ) (bvsle  (_ bv4294967291 32) ?B1 ) ) (bvsle  ?B1 (_ bv5 32) ) ) (=  false (bvsle  (_ bv4294967291 32) (concat  (select  z (_ bv3 32) ) (concat  (select  z (_ bv2 32) ) (concat  (select  z (_ bv1 32) ) (select  z (_ bv0 32) ) ) ) ) ) ) ) ) )
(check-sat)
(exit)
