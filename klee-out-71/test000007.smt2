...
(assert (let ( (?B1 (concat  (select  z (_ bv3 32) ) (concat  (select  z (_ bv2 32) ) (concat  (select  z (_ bv1 32) ) (select  z (_ bv0 32) ) ) ) ) ) (?B2 (concat  (select  y (_ bv3 32) ) (concat  (select  y (_ bv2 32) ) (concat  (select  y (_ bv1 32) ) (select  y (_ bv0 32) ) ) ) ) ) (?B3 (concat  (select  x (_ bv3 32) ) (concat  (select  x (_ bv2 32) ) (concat  (select  x (_ bv1 32) ) (select  x (_ bv0 32) ) ) ) ) ) ) (and  (and  (and  (and  (and  (and  (and  (and  (bvsle  (_ bv4294967246 32) ?B3 ) (bvsle  ?B3 (_ bv50 32) ) ) (bvsle  (_ bv4294967246 32) ?B2 ) ) (bvsle  ?B2 (_ bv50 32) ) ) (bvsle  (_ bv4294967246 32) ?B1 ) ) (bvsle  ?B1 (_ bv50 32) ) ) (=  false (=  (_ bv5 32) (bvsrem  (bvmul  (bvmul  ?B3 ?B2 ) ?B1 ) (_ bv11 32) ) ) ) ) (=  false (bvslt  (_ bv60 32) (bvadd  (bvadd  ?B3 ?B2 ) ?B1 ) ) ) ) (=  false (=  (_ bv3 32) (bvsrem  (bvsub  (bvadd  (bvmul  ?B3 ?B3 ) (bvmul  ?B2 ?B2 ) ) (bvmul  ?B1 ?B1 ) ) (_ bv12 32) ) ) ) ) ) )
(check-sat)
(exit)
