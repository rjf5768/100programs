...
@.str.3 = private unnamed_addr constant [5 x i8] c"36.c\00", align 1
...
18:                                               ; preds = %15, %12, %9, %0
  ...
  %25 = load i32, i32* %2, align 4, !dbg !71
  %26 = load i32, i32* %4, align 4, !dbg !73
  %int_cast_to_i64 = zext i32 %26 to i64, !dbg !74
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !74
  %27 = srem i32 %25, %26, !dbg !74, !klee.check.div !32
  %28 = icmp ne i32 %27, 0, !dbg !75
  br i1 %28, label %34, label %29, !dbg !76

29:                                               ; preds = %18
  %30 = load i32, i32* %3, align 4, !dbg !77
  %31 = load i32, i32* %4, align 4, !dbg !78
  %int_cast_to_i641 = zext i32 %31 to i64, !dbg !79
  call void @klee_div_zero_check(i64 %int_cast_to_i641), !dbg !79
  %32 = srem i32 %30, %31, !dbg !79, !klee.check.div !32
  %33 = icmp ne i32 %32, 0, !dbg !80
  br i1 %33, label %34, label %35, !dbg !81

34:                                               ; preds = %29, %18
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 noundef 21, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !82
  unreachable, !dbg !82
...
define dso_local void @klee_div_zero_check(i64 %0) #4 !dbg !84 {
  %2 = alloca i64, align 8
  store i64 %0, i64* %2, align 8
  call void @llvm.dbg.declare(metadata i64* %2, metadata !89, metadata !DIExpression()), !dbg !90
  %3 = load i64, i64* %2, align 8, !dbg !91
  %4 = icmp eq i64 %3, 0, !dbg !93
  br i1 %4, label %5, label %6, !dbg !94

5:                                                ; preds = %1
  call void @klee_report_error(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.4, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1.5, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2.6, i64 0, i64 0)) #7, !dbg !95
  unreachable, !dbg !95
...
!1 = !DIFile(filename: "36.c", directory: "/home/rongfeng/klee/code/100 programs", checksumkind: CSK_MD5, checksum: "caaa9f5cbfdc2f221cd25d80b6535a7d")
...
!71 = !DILocation(line: 20, column: 6, scope: !72)
!72 = distinct !DILexicalBlock(scope: !41, file: !1, line: 20, column: 6)
!73 = !DILocation(line: 20, column: 10, scope: !72)
!74 = !DILocation(line: 20, column: 8, scope: !72)
!75 = !DILocation(line: 20, column: 12, scope: !72)
!76 = !DILocation(line: 20, column: 17, scope: !72)
!77 = !DILocation(line: 20, column: 20, scope: !72)
!78 = !DILocation(line: 20, column: 24, scope: !72)
!79 = !DILocation(line: 20, column: 22, scope: !72)
!80 = !DILocation(line: 20, column: 26, scope: !72)
!81 = !DILocation(line: 20, column: 6, scope: !41)
!82 = !DILocation(line: 21, column: 5, scope: !72)
!83 = !DILocation(line: 22, column: 3, scope: !41)
!84 = distinct !DISubprogram(name: "klee_div_zero_check", scope: !85, file: !85, line: 12, type: !86, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!85 = !DIFile(filename: "runtime/Intrinsic/klee_div_zero_check.c", directory: "/home/rongfeng/klee")
!86 = !DISubroutineType(types: !87)
!87 = !{null, !88}
!88 = !DIBasicType(name: "long long int", size: 64, encoding: DW_ATE_signed)
!89 = !DILocalVariable(name: "z", arg: 1, scope: !84, file: !85, line: 12, type: !88)
!90 = !DILocation(line: 12, column: 36, scope: !84)
!91 = !DILocation(line: 13, column: 7, scope: !92)
!92 = distinct !DILexicalBlock(scope: !84, file: !85, line: 13, column: 7)
!93 = !DILocation(line: 13, column: 9, scope: !92)
!94 = !DILocation(line: 13, column: 7, scope: !84)
!95 = !DILocation(line: 14, column: 5, scope: !92)
!96 = !DILocation(line: 15, column: 1, scope: !84)
