...
@.str.2 = private unnamed_addr constant [4 x i8] c"4.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @fib(i32 noundef %0) #0 !dbg !10 {
...
8:                                                ; preds = %1
  ...
  %11 = call i32 @fib(i32 noundef %10), !dbg !25
  %12 = load i32, i32* %3, align 4, !dbg !26
  %13 = sub nsw i32 %12, 2, !dbg !27
  %14 = call i32 @fib(i32 noundef %13), !dbg !28
...
define dso_local i32 @main() #0 !dbg !32 {
  ...
  %14 = call i32 @fib(i32 noundef %13), !dbg !48
...
17:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32 noundef 17, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #4, !dbg !53
  unreachable, !dbg !53
...
!1 = !DIFile(filename: "4.c", directory: "/home/rongfeng/klee/code/100 programs", checksumkind: CSK_MD5, checksum: "93b7a27d6b3ae6e00b61d1bf03e4f70a")
...
!10 = distinct !DISubprogram(name: "fib", scope: !1, file: !1, line: 5, type: !11, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !14)
...
!21 = !DILocation(line: 6, column: 21, scope: !18)
!22 = !DILocation(line: 6, column: 14, scope: !18)
!23 = !DILocation(line: 7, column: 14, scope: !10)
!24 = !DILocation(line: 7, column: 16, scope: !10)
!25 = !DILocation(line: 7, column: 10, scope: !10)
!26 = !DILocation(line: 7, column: 27, scope: !10)
!27 = !DILocation(line: 7, column: 29, scope: !10)
!28 = !DILocation(line: 7, column: 23, scope: !10)
!29 = !DILocation(line: 7, column: 21, scope: !10)
...
!34 = !{!13}
!35 = !DILocalVariable(name: "n", scope: !32, file: !1, line: 11, type: !13)
!36 = !DILocation(line: 11, column: 7, scope: !32)
!37 = !DILocation(line: 12, column: 22, scope: !32)
!38 = !DILocation(line: 12, column: 3, scope: !32)
!39 = !DILocation(line: 13, column: 15, scope: !32)
!40 = !DILocation(line: 13, column: 17, scope: !32)
!41 = !DILocation(line: 13, column: 3, scope: !32)
!42 = !DILocation(line: 14, column: 15, scope: !32)
!43 = !DILocation(line: 14, column: 17, scope: !32)
!44 = !DILocation(line: 14, column: 3, scope: !32)
!45 = !DILocalVariable(name: "result", scope: !32, file: !1, line: 15, type: !13)
!46 = !DILocation(line: 15, column: 7, scope: !32)
!47 = !DILocation(line: 15, column: 20, scope: !32)
!48 = !DILocation(line: 15, column: 16, scope: !32)
!49 = !DILocation(line: 16, column: 6, scope: !50)
!50 = distinct !DILexicalBlock(scope: !32, file: !1, line: 16, column: 6)
!51 = !DILocation(line: 16, column: 13, scope: !50)
!52 = !DILocation(line: 16, column: 6, scope: !32)
!53 = !DILocation(line: 17, column: 5, scope: !50)
!54 = !DILocation(line: 18, column: 3, scope: !32)
