...
@.str.3 = private unnamed_addr constant [5 x i8] c"54.c\00", align 1
...
14:                                               ; preds = %0
  ...
  %17 = sub nsw i32 %15, %16, !dbg !34
  br label %18, !dbg !28

18:                                               ; preds = %14, %10
  %19 = phi i32 [ %13, %10 ], [ %17, %14 ], !dbg !28
  store i32 %19, i32* %4, align 4, !dbg !35
  %20 = load i32, i32* %2, align 4, !dbg !36
  %21 = load i32, i32* %3, align 4, !dbg !38
  %22 = icmp sge i32 %20, %21, !dbg !39
  br i1 %22, label %23, label %28, !dbg !40

23:                                               ; preds = %18
  %24 = load i32, i32* %4, align 4, !dbg !41
  %25 = load i32, i32* %2, align 4, !dbg !42
  %26 = icmp slt i32 %24, %25, !dbg !43
  br i1 %26, label %27, label %28, !dbg !44

27:                                               ; preds = %23
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 noundef 11, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #4, !dbg !45
  unreachable, !dbg !45
...
!1 = !DIFile(filename: "54.c", directory: "/home/rongfeng/klee/code/100 programs", checksumkind: CSK_MD5, checksum: "bfe7d6ffa2f5d342d7d7f220b2d41fb6")
...
!27 = !DILocation(line: 9, column: 15, scope: !10)
!28 = !DILocation(line: 9, column: 12, scope: !10)
!29 = !DILocation(line: 9, column: 24, scope: !10)
!30 = !DILocation(line: 9, column: 28, scope: !10)
!31 = !DILocation(line: 9, column: 26, scope: !10)
!32 = !DILocation(line: 9, column: 34, scope: !10)
!33 = !DILocation(line: 9, column: 38, scope: !10)
!34 = !DILocation(line: 9, column: 36, scope: !10)
!35 = !DILocation(line: 9, column: 10, scope: !10)
!36 = !DILocation(line: 10, column: 6, scope: !37)
!37 = distinct !DILexicalBlock(scope: !10, file: !1, line: 10, column: 6)
!38 = !DILocation(line: 10, column: 11, scope: !37)
!39 = !DILocation(line: 10, column: 8, scope: !37)
!40 = !DILocation(line: 10, column: 13, scope: !37)
!41 = !DILocation(line: 10, column: 16, scope: !37)
!42 = !DILocation(line: 10, column: 25, scope: !37)
!43 = !DILocation(line: 10, column: 23, scope: !37)
!44 = !DILocation(line: 10, column: 6, scope: !10)
!45 = !DILocation(line: 11, column: 5, scope: !37)
