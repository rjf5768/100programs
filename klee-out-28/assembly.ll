...
@.str.3 = private unnamed_addr constant [5 x i8] c"29.c\00", align 1
...
define dso_local i32 @main() #0 !dbg !14 {
  ...
  %13 = srem i32 %11, %12, !dbg !33, !klee.check.div !34
  store i32 %13, i32* %4, align 4, !dbg !35
  %14 = load i32, i32* %4, align 4, !dbg !36
  %15 = icmp slt i32 %14, 0, !dbg !38
  br i1 %15, label %20, label %16, !dbg !39

16:                                               ; preds = %0
  %17 = load i32, i32* %4, align 4, !dbg !40
  %18 = load i32, i32* %3, align 4, !dbg !41
  %19 = icmp sge i32 %17, %18, !dbg !42
  br i1 %19, label %20, label %21, !dbg !43

20:                                               ; preds = %16, %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 noundef 12, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !44
  unreachable, !dbg !44
...
define dso_local void @klee_div_zero_check(i64 %0) #4 !dbg !46 {
  ...
  %4 = icmp eq i64 %3, 0, !dbg !55
  br i1 %4, label %5, label %6, !dbg !56

5:                                                ; preds = %1
  call void @klee_report_error(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.4, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1.5, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2.6, i64 0, i64 0)) #7, !dbg !57
  unreachable, !dbg !57
...
!1 = !DIFile(filename: "29.c", directory: "/home/rongfeng/klee/code/100 programs", checksumkind: CSK_MD5, checksum: "276a0ed782672adf523e77cfff3e7f88")
...
!22 = !DILocalVariable(name: "mod", scope: !14, file: !1, line: 6, type: !17)
...
!31 = !DILocation(line: 10, column: 9, scope: !14)
!32 = !DILocation(line: 10, column: 13, scope: !14)
!33 = !DILocation(line: 10, column: 11, scope: !14)
!34 = !{!"True"}
!35 = !DILocation(line: 10, column: 7, scope: !14)
!36 = !DILocation(line: 11, column: 6, scope: !37)
!37 = distinct !DILexicalBlock(scope: !14, file: !1, line: 11, column: 6)
!38 = !DILocation(line: 11, column: 10, scope: !37)
!39 = !DILocation(line: 11, column: 14, scope: !37)
!40 = !DILocation(line: 11, column: 17, scope: !37)
!41 = !DILocation(line: 11, column: 24, scope: !37)
!42 = !DILocation(line: 11, column: 21, scope: !37)
!43 = !DILocation(line: 11, column: 6, scope: !14)
!44 = !DILocation(line: 12, column: 5, scope: !37)
!45 = !DILocation(line: 13, column: 3, scope: !14)
!46 = distinct !DISubprogram(name: "klee_div_zero_check", scope: !47, file: !47, line: 12, type: !48, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!47 = !DIFile(filename: "runtime/Intrinsic/klee_div_zero_check.c", directory: "/home/rongfeng/klee")
!48 = !DISubroutineType(types: !49)
!49 = !{null, !50}
!50 = !DIBasicType(name: "long long int", size: 64, encoding: DW_ATE_signed)
!51 = !DILocalVariable(name: "z", arg: 1, scope: !46, file: !47, line: 12, type: !50)
!52 = !DILocation(line: 12, column: 36, scope: !46)
!53 = !DILocation(line: 13, column: 7, scope: !54)
!54 = distinct !DILexicalBlock(scope: !46, file: !47, line: 13, column: 7)
!55 = !DILocation(line: 13, column: 9, scope: !54)
!56 = !DILocation(line: 13, column: 7, scope: !46)
!57 = !DILocation(line: 14, column: 5, scope: !54)
!58 = !DILocation(line: 15, column: 1, scope: !46)
