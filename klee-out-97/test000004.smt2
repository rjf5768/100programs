...
(assert (let ( (?B1 (concat  (select  step (_ bv3 32) ) (concat  (select  step (_ bv2 32) ) (concat  (select  step (_ bv1 32) ) (select  step (_ bv0 32) ) ) ) ) ) (?B2 (concat  (select  step_1 (_ bv3 32) ) (concat  (select  step_1 (_ bv2 32) ) (concat  (select  step_1 (_ bv1 32) ) (select  step_1 (_ bv0 32) ) ) ) ) ) (?B3 (concat  (select  steps (_ bv3 32) ) (concat  (select  steps (_ bv2 32) ) (concat  (select  steps (_ bv1 32) ) (select  steps (_ bv0 32) ) ) ) ) ) ) (and  (and  (and  (and  (and  (and  (and  (bvsle  (_ bv1 32) ?B3 ) (bvsle  ?B3 (_ bv50 32) ) ) (bvsle  (_ bv4294967295 32) ?B1 ) ) (bvsle  ?B1 (_ bv1 32) ) ) (bvslt  (_ bv1 32) ?B3 ) ) (bvsle  (_ bv4294967295 32) ?B2 ) ) (bvsle  ?B2 (_ bv1 32) ) ) (=  false (bvslt  (_ bv2 32) ?B3 ) ) ) ) )
(check-sat)
(exit)
