...
@.str.3 = private unnamed_addr constant [5 x i8] c"53.c\00", align 1
...
18:                                               ; preds = %14, %10
  ...
  br i1 %21, label %22, label %23, !dbg !39

22:                                               ; preds = %18
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 noundef 11, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #4, !dbg !40
  unreachable, !dbg !40
...
!1 = !DIFile(filename: "53.c", directory: "/home/rongfeng/klee/code/100 programs", checksumkind: CSK_MD5, checksum: "5b9faaec90286063fb5aaa53c3a57e6c")
...
!26 = !DILocation(line: 9, column: 17, scope: !10)
!27 = !DILocation(line: 9, column: 15, scope: !10)
!28 = !DILocation(line: 9, column: 12, scope: !10)
!29 = !DILocation(line: 9, column: 22, scope: !10)
!30 = !DILocation(line: 9, column: 26, scope: !10)
!31 = !DILocation(line: 9, column: 24, scope: !10)
!32 = !DILocation(line: 9, column: 30, scope: !10)
!33 = !DILocation(line: 9, column: 34, scope: !10)
!34 = !DILocation(line: 9, column: 32, scope: !10)
...
!39 = !DILocation(line: 10, column: 6, scope: !10)
